          ...
          <div className="text-sm leading-relaxed prose prose-sm dark:prose-invert max-w-none">
            <ReactMarkdown
              components={{
                ...
                h2: ({ children }) => <h2 className="text-base font-bold mb-2 text-foreground flex items-center gap-2">{children}</h2>,
                ...
                blockquote: ({ children }) => (
                  <blockquote className="border-l-3 border-saffron pl-4 italic text-muted-foreground my-2">
                    {children}
                  </blockquote>
                ),
              }}
